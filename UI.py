...
class UI:
    ...
    def __init__(self, size: Tuple[int, int]) -> None:
        ...
        self._distance_label = pygame_gui.elements.UILabel(
            ...
            text="plate separation: 0.05 (m)", manager=self._manager)
    ...
    def ui_update(self, time_delta: float, reset_callback: Callable, mass: float, velocity: float, acc: float) -> None:
        ...
        self._pd_label.set_text(
            f"Potential Difference (V): {self._slider.get_current_value() / 100}")
